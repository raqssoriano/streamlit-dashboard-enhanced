...
pie_chart = px.pie(grouped_data, names='learning_modality', values='operational_schools', title='Percentage of Students in each Learning Modality', color_discrete_sequence=pastel_colors)
